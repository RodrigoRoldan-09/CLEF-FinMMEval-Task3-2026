...
\begin{document}
    ...
    \subsection{Temporal Encoding: The Chronos-Bolt Module}
    ...
    \subsection{Multimodal Sentiment Extraction: The \textit{finvert} Module}
    ...
    \subsubsection{Auto-Discovery and Text Combination}
    ...
    \subsubsection{FinBERT Inference and Batch Processing}
    ...
    \subsection{Dynamic Prompt Routing and Temporal Memory}
    ...
    \subsubsection{Tripartite Memory Architecture}
    ...
    \subsubsection{Strategy V1: Programmatic Auto-Reflection}
    ...
    \subsubsection{Strategy V2: Dual-LLM Pipeline and Semantic FIFO Queuing}
    ...
    \subsubsection{Heuristic Risk Management via System Prompts}
