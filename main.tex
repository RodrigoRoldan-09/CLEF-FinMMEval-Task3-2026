...
<<<<<<< Updated upstream
    ...
    \subsection{Problem Formulation and Main Objectives}
    ...
    \subsection{Architecture and Training Configuration}

    \subsubsection{Base Model and Quantization Strategy}
    ...
    \subsubsection{Hybrid Two-Stage Training Pipeline}
    ...
    \subsubsection{Ground Truth Signal Generation}
    ...
    \subsection{Optuna Search and Experimental Protocol}
    ...
    \subsection{Reward Function Design and Engineering Contributions}

    \subsubsection{Asymmetric Reward Matrix}
    ...
    \subsubsection{Decision Placement Reward and Length Penalty}
    ...
    \subsubsection{Truncated Token Rescue}
    ...
    \subsubsection{Complete Reward Formula}
    ...
    \subsection{Training and Fast-Mode Results}
